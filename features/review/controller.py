    ...
    def process_tags(store_data):
        ...
        if photo_status == "captured" and description_status == "pending":
            ...
            try:
                ...
                from components.state_utils import serialise_state
        ...
        print("DEBUG: Calling extract_tags from process_tags")
        ...
        print(
            f"DEBUG: process_tags completed, tags status: {state['tags'].get('status')}"
        )
